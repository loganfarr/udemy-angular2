...
var UsersService = (function () {
    ...
    UsersService.prototype.updateUser = function (user, id) {
        return this._http.put(this._url + '/' + id, JSON.stringify(user)).map(function (res) { return res.json(); });
    };
    UsersService.prototype.deleteUser = function (id) {
        return this._http.delete(this._url).map(function (res) { return res.json(); });
    };
